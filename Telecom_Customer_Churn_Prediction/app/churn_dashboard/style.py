...
from data import BG, CARD_BORDER, BLACK, WHITE
...
def inject_css():
    st.markdown(
        ...
        .kpi-label {{ color: #DE6A73; font-size: 14px; }}
        .kpi-label-white {{ color: {WHITE}; font-size: 14px; }}
        .kpi-value {{ color: {WHITE}; font-size: 26px; font-weight: 700; }}
        .kpi-value-rose {{ color: #DE6A73; font-size: 26px; font-weight: 700; }}
        .chart-card {{
            background-color: {BG};
            border: 1px solid {CARD_BORDER};
            border-radius: 6px;
        ...
        .chart-title {{ color: {WHITE}; font-weight: 600; font-size: 15px; margin-bottom: 4px; }}
        .slicer-card {{
            background-color: {BG};
            border: 1px solid {CARD_BORDER};
            border-radius: 6px;
        ...
        .slicer-title {{ color: {WHITE}; font-weight: 600; font-size: 14px; margin-bottom: 6px; }}
        div[data-testid="stMetric"] {{ background-color: {BG}; }}
        </style>
        """,
