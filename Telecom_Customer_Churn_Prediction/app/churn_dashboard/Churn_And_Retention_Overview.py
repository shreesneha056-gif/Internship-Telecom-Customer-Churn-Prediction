...
from charts import banded_area_chart
...
with c3:
    ...
    fill_colors = [colors.MAROON, colors.GREY_FILL, colors.MAROON, colors.GREY_FILL]
    line_colors = [colors.ROSE, colors.WHITE, colors.ROSE, colors.WHITE]
    fig = banded_area_chart(trates.index, trates.values, fill_colors, line_colors, colors.BG, colors.WHITE)
    st.plotly_chart(fig, use_container_width=True, config={"displayModeBar": False})
    chart_card_close()
